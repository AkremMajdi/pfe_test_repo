...
ANNUAL_DATA_PATH = DATA_DIR / "refined_tunisia_wildfire_dataset.csv"
ANNUAL_BUNDLE_PATH = MODELS_DIR / "annual_governorate_model_bundle.joblib"
ANNUAL_PREDICTIONS_PATH = DATA_DIR / "annual_governorate_predictions.csv"
ANNUAL_METRICS_PATH = DATA_DIR / "annual_governorate_metrics.json"

PIXEL_DATA_PATH = DATA_DIR / "final_trainable_500m_wildfire_dataset_model_aligned.csv"
PIXEL_BUNDLE_PATH = MODELS_DIR / "operational_pixel_proxy_model_bundle.joblib"
PIXEL_SCORES_PATH = DATA_DIR / "operational_pixel_scores_all.csv"
PIXEL_METRICS_PATH = DATA_DIR / "operational_pixel_proxy_metrics.json"
PIXEL_IMPORTANCE_PATH = DATA_DIR / "operational_pixel_proxy_feature_importance.csv"
BRIDGE_PATH = DATA_DIR / "bridge_annual_pixel_alerts.csv"
...
def load_pixel_scores() -> pd.DataFrame:
    require_file(PIXEL_SCORES_PATH, "precomputed pixel scores")
...
def load_bridge() -> pd.DataFrame:
    require_file(BRIDGE_PATH, "annual-pixel bridge dataset")
